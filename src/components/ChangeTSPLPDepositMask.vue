    ...
    async addDeposit() {
      try {
        ...
        if (res && (await isTransactionSuccess(res))) {
          ...
          this.$parent.minedTspLP = parseFloat(
            this.$parent.minedTspLP2
          ).toFixed(3);
          this.$parent.balanceOfTSPLP2 =
            parseFloat(this.$parent.balanceOfTSPLP2) - b;
          this.$parent.balanceOfTSPLP = parseFloat(
            this.$parent.balanceOfTSPLP2
          ).toFixed(3);
          this.hideMask();
        } else {
    ...
    async subDeposit() {
      try {
        ...
        if (res && (await isTransactionSuccess(res))) {
          ...
          this.$parent.balanceOfTSPLP2 =
            parseFloat(this.$parent.balanceOfTSPLP2) + a;
          this.$parent.balanceOfTSPLP = parseFloat(
            this.$parent.balanceOfTSPLP2
          ).toFixed(3);

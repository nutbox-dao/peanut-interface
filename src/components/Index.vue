      ...
      <div>
        ...
        <div class="delegate">
          ...
          <div class="delegatetext round-box">
            ...
            {{ totalDepositedSP }} SP<br />
            {{ $t("message.totalpnut") }}： {{ totalPendingPeanuts }} PNUT<br />
            {{ $t("message.rewardperblock") }}：
            {{ rewardsPerBlock }} PNUT<br />
          ...
          <div v-if="balanceOfDelegate2 > 0">
            ...
            <div class="confirm-box">
              <button
                ...
                :disabled="!loadingFlag || !(fee <= parseFloat(balanceOfSeem))"
              >
...
export default {
  ...
  methods: {
    ...
    async getSteemStates() {
      ...
      let delegatedSp =
        parseFloat(s[0].delegated_vesting_shares) * this.vestsToSp;
    ...
    async delegate() {
      try {
        ...
        res = await this.steemDelegation(
          delegator,
          delegatee,
          amount,
          this.addr
    ...
    async calPnutApy() {
      ...
      let apy =
        (28800 * this.rewardsPerBlock * 365 * pnutPrice * tronPrice) /
        (this.totalDepositedSP2 * steemPrice);

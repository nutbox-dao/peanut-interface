        ...
        <div v-if="steemFlag" class="exchange">
          ...
          <div class="round-box">
            <div class="round-box-title-container">
              ...
              <p class="box-title">
                {{ $t('message.balance') }}: {{ isSteemToTSteem ? balanceOfSeem : balanceOf }}
              </p>
            </div>
            <div class="round-box-content-container">
              ...
              placeholder="0.0" v-model="transValue"
              @keyup="checkTransValue" type="number" inputmode="decimal"
              pattern="^[0-9]*[.,]?[0-9]*$" spellcheck="false"    value>
              <div style="display:flex">
               <button class="maxBtn" @click="fillMaxTrans">Max</button>
               <img class="coin-icon" src="../../static/images/steem.svg" alt="" v-if="isSteemToTSteem">
               <img class="coin-icon" src="../../static/images/tsteem.svg" alt="" v-else>
          ...
          <div class="round-box">
            <div class="round-box-title-container">
              ...
              <p class="box-title">
                {{ $t('message.balance') }}: {{ isSteemToTSteem ? balanceOf : balanceOfSeem }}
              </p>
            </div>
            <div class="round-box-content-container">
              <input
              ...
              <div style="display:flex">
                <img class="coin-icon" src="../../static/images/tsteem.svg" alt="" v-if="isSteemToTSteem">
                <img class="coin-icon" src="../../static/images/steem.svg" alt="" v-else>
              <div style="margin-top:18px;margin-left:8px">{{ isSteemToTSteem ? "TSTEEM" : "STEEM" }}</div>
              </div>
            </div>
          </div>
          <!-- 按钮 -->
          ...
          <!--手续费-->
          <p style="width:100%;text-align:center;font-size:14px;color:gray;margin:0;padding-top:8px" v-if="isSteemToTSteem">
            {{ $t('message.servicecharge') }}： 0.2%，{{ $t('message.atleastcharge') }} 0.1 STEEM
          </p>
          <!-- 兑换率 -->
          <p style="width:100%;text-align:center;font-size:14px;color:gray;margin:0;padding-top:8px" v-if="isSteemToTSteem">
      ...
      <div v-if="sbdFlag" class="exchange">
        ...
        <div class="round-box">
          <div class="round-box-title-container">
            ...
            <p class="box-title">
              {{ $t('message.balance') }}: {{ isSbdToTSbd ? balanceOfSbd : balanceOfTsbd }}
            </p>
          </div>
          <div class="round-box-content-container">
            <input
                    ...
                    placeholder="0.0" v-model="transSbdValue"
                    @keyup="checkTransSbdValue" type="number" inputmode="decimal"
                    pattern="^[0-9]*[.,]?[0-9]*$" spellcheck="false" value>
            <div style="display:flex">
              <button class="maxBtn" @click="fillMaxSbdTrans">Max</button>
              <img class="coin-icon" src="../../static/images/sbd.svg" alt="" v-if="isSbdToTSbd">
              <img class="coin-icon" src="../../static/images/tsbd.svg" alt="" v-else>
              <div style="margin-top:18px;margin-left:8px">{{ isSbdToTSbd ? "SBD" : "TSBD" }}</div>
            </div>
          </div>
        </div>
        <!-- 中间箭头 -->
        ...
        <div class="round-box">
          <div class="round-box-title-container">
            ...
            <p class="box-title">
              {{ $t('message.balance') }}: {{ isSbdToTSbd ? balanceOfTsbd : balanceOfSbd  }}
            </p>
          </div>
          <div class="round-box-content-container">
            <input
                    ...
                    pattern="^[0-9]*[.,]?[0-9]*$" spellcheck="false" value>
            <div style="display:flex">
              <img class="coin-icon" src="../../static/images/tsbd.svg" alt="" v-if="isSbdToTSbd">
              <img class="coin-icon" src="../../static/images/sbd.svg" alt="" v-else>
              <div style="margin-top:18px;margin-left:8px">{{ isSbdToTSbd ? "TSBD" : "SBD" }}</div>
            </div>
          </div>
        </div>
        <!-- 按钮 -->
        ...
        <!--手续费-->
        <p style="width:100%;text-align:center;font-size:14px;color:gray;margin:0;padding-top:8px" v-if="isSbdToTSbd">
          {{ $t('message.servicecharge') }}： 0.2%，{{ $t('message.atleastcharge') }} 0.015 SBD
        </p>
        <!-- 兑换率 -->
        <p style="width:100%;text-align:center;font-size:14px;color:gray;margin:0;padding-top:8px" v-if="isSbdToTSbd">
  ...
  export default {
    ...
    methods: {
      ...
      checkTransValue(){
        ...
        if (this.isSteemToTSteem){
          let res2 = parseFloat(this.transValue) <= parseFloat(parseFloat(this.balanceOfSeem) - steemfee).toFixed(3)
      ...
      checkTransSbdValue(){
        ...
        if (this.isSbdToTSbd){
          let res2 = parseFloat(this.transSbdValue) <= parseFloat(parseFloat(this.balanceOfSbd) - sbdfee).toFixed(3)

          this.canTransSbdFlag = res1 && res && res2
          this.checkSbdFlag = this.canTransSbdFlag
        }else{
          let res3 = parseFloat(this.transSbdValue) <= parseFloat(this.balanceOfTsbd2)
